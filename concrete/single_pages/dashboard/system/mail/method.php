...
?>
	...
	<div class="controls">
	<div class="radio"><label><?php echo $form->radio('MAIL_SEND_METHOD', 'PHP_MAIL', Config::get('concrete.mail.method'))?> <span><?php echo t('Default PHP Mail Function')?></span></label></div>
    <div class="radio"><label><?php echo $form->radio('MAIL_SEND_METHOD', 'SMTP', Config::get('concrete.mail.method'))?> <span><?php echo t('External SMTP Server')?></span></label></div>
	</div>
	</div>
	</fieldset>
